...
# 5 Lista el código de los fabricantes que tienen productos en la tabla producto
 select fabricante.nombre, codigo_fabricante from producto join fabricante on producto.codigo_fabricante = fabricante.codigo ;
# 6 Lista el código de los fabricantes que tienen productos en la tabla producto, sin mostrar
# los repetidos.
select distinct fabricante.nombre, codigo_fabricante from producto join fabricante on producto.codigo_fabricante = fabricante.codigo ;
# 7 Lista los nombres de los fabricantes ordenados de forma ascendente
select nombre from fabricante order by nombre desc; #asc
